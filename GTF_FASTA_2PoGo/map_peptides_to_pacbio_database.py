...
### input files
pacbio_fasta_file = "./data/SMC_CORRECTED_orf_refined.fasta"

pacbio_gtf_file = "./data/SMC_CORRECTED_with_cds.gtf"
...
pacbio_fasta_prefix = output_directory + "SMC_CORRECTED_orf_refined"
pacbio_gtf_prefix = output_directory + "SMC_CORRECTED_with_cds"
